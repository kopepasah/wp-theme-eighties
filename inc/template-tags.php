...
if ( ! function_exists( 'eighties_comment' ) ) :
	 ...
	 *
	 * @since 1.0.0
	 * @param string $comment for the function.
	 * @param array  $args for the function.
	 * @param string $depth for the function.
	 */
...
function eighties_get_time_difference( $time ) {
	...
	} elseif ( 12 >= $difference->m && 1 <= $difference->m ) {
		/**
